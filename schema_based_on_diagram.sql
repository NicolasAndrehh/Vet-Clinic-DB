...
CREATE INDEX idx_invoice_items_treatment_id
ON invoice_items(treatment_id);

CREATE INDEX idx_medical_history_treatment_medical_history_id
ON medical_history_treatment(medical_history_id);

CREATE INDEX idx_medical_history_treatment_treatment_id
ON medical_history_treatment(treatment_id);
